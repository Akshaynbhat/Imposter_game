...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-8 relative">
      ...
      {/* Main Glass Card */}
      <div className="w-full max-w-md glass-panel rounded-3xl p-6 sm:p-8 border border-purple-500/20 shadow-2xl relative z-10 animate-glow-pulse">
        {/* Header Hero Title */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-500 to-neon-blue p-[2px] mb-4 shadow-lg shadow-purple-500/30">
            <div className="w-full h-full bg-[#0b0a1a] rounded-[14px] flex items-center justify-center">
              <ShieldAlert className="w-8 h-8 text-neon-cyan animate-bounce" />
            </div>
          </div>
        ...
        {(error || validationError) && (
          <div className="mb-6 p-3.5 rounded-xl bg-rose-500/15 border border-rose-500/30 text-rose-300 text-sm font-semibold text-center flex items-center justify-center gap-2">
            <span>⚠️</span>
      ...
      {isJoinModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="w-full max-w-md glass-panel rounded-3xl p-6 sm:p-8 border border-purple-500/30 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
